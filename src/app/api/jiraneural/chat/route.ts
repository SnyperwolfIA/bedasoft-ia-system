  ...
  try {
    ...
    if (!user && isAuthorizedAdminDomain(userEmail)) {
      try {
        ...
        console.log(`[Auth Auto-Register] Creado usuario corporativo en JiraNeural: ${userEmail}`);
      } catch (dbErr: any) {
        console.error('[Auth Auto-Register] Error en base de datos al auto-registrar usuario en JiraNeural, usando mock:', dbErr);
        user = {
